...
/**
 * Plugin Taxonomy Controller class.
 * 
 * Plugin Taxonomy Controller class.
 * 
 * @since               0.3.0
...
class Taxonomy extends Controller {
    ...
    /**
     * To store the array of sub-pages of the taxonomy.
     *
     * @var array
     */
    ...
    /**
     * Prepares and adds the taxonomy.
     *
     * @return void
     */
    public function register() {
        // Set the settings section ID.
        $this->settings_section_id = 'taxonomy-mgmt';
        
        // Do not load the taxonomy and it's management section if its option is not activated.
    ...
    public function set_subpages() {
        $this->subpages = array(
            array(
                ...
                'menu_slug'     => 'lbd-taxonomy',
                'callback'      => array( $this->callbacks, 'taxonomy_dashboard' ),
                'position'      => 2
            )
        );
