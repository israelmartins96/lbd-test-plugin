...
class Post_Type extends Controller {
    ...
    /**
     * Sets a fallback value when the value of given parameter is invalid.
     *
     * @param mixed $param
     * @param mixed $fallback
     * @return $value
     */
    public function set_or_fallback( $param, $fallback ) {
        if ( ! is_null( $param ) ) {
            $value = $param;
        }
    ...
    /**
     * Activates/Creates the custom post type(s).
     *
     * @return void
     */
    public function register_custom_post_types() {
        ...
        foreach ( $this->custom_post_types as $post_type ) {
            ...
            $args = array(
                ...
                'capabilities'                      => isset( $post_type['capabilities'] ) ? $this->set_or_fallback( $post_type['capabilities'], $fallback_capabilities ) : $fallback_capabilities,
                'map_meta_cap'                      => isset( $post_type['map_meta_cap'] ) ? $post_type['map_meta_cap'] : true,
                'supports'                          => isset( $post_type['supports'] ) ? $this->set_or_fallback( $post_type['supports'], $fallback_supports ) : $fallback_supports,
                ...
                'rewrite'                           => isset( $post_type['rewrite'] ) ? $this->set_or_fallback( $post_type['rewrite'], $fallback_rewrite ) : $fallback_rewrite,
